...
export default function BookImportPage() {
  ...
  const downloadTemplate = () => {
    ...
    const sampleData = [
      "BK001,The Great Gatsby,F. Scott Fitzgerald,978-0743273565,Scribner,1925,Fiction,A novel about the American Dream,5,A-1",
      "BK002,1984,George Orwell,978-0451524935,Signet Classic,1949,Fiction,Dystopian social science fiction,3,A-2",
    ];
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary">book_id</Badge>
              ...
              <div className="space-y-2">
                ...
                <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                  ...
                  <li>book_id must be unique for each book</li>
                  <li>Duplicate book_ids will be skipped</li>
                  <li>Default total_copies is 1 if not specified</li>
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="w-32">Book ID</TableHead>
