  ...
  return (
    <div className='p-8'>
      ...
      <div className='grid grid-cols-1 gap-6 lg:grid-cols-2'>
          ...
          <div className='space-y-3'>
            <div className='hover:bg-muted/20 flex items-center gap-3 rounded-lg p-3'>
              ...
              <div className='flex-1'>
                <div className='text-sm font-medium text-foreground'>Book returned</div>
            ...
            <div className='hover:bg-muted/20 flex items-center gap-3 rounded-lg p-3'>
              ...
              <div className='flex-1'>
                <div className='text-sm font-medium text-foreground'>New book added</div>
                <div className='text-muted-foreground text-xs'>
            ...
            <div className='hover:bg-muted/20 flex items-center gap-3 rounded-lg p-3'>
              ...
              <div className='flex-1'>
                <div className='text-sm font-medium text-foreground'>Overdue reminder sent</div>
                <div className='text-muted-foreground text-xs'>
                  To 3 students
                </div>
              </div>
        ...
        <div className='bg-card rounded-2xl border border-border shadow-sm p-6'>
          <h3 className='mb-4 text-lg font-semibold text-foreground'>Popular Books</h3>
          <div className='space-y-3'>
            <div className='hover:bg-muted/20 flex items-center gap-3 rounded-lg p-3'>
              ...
              <div className='flex-1'>
                <div className='text-sm font-medium text-foreground'>The Great Gatsby</div>
                <div className='text-muted-foreground text-xs'>
                  Borrowed 24 times
                </div>
              </div>
            ...
            <div className='hover:bg-muted/20 flex items-center gap-3 rounded-lg p-3'>
              ...
              <div className='flex-1'>
                <div className='text-sm font-medium text-foreground'>To Kill a Mockingbird</div>
                <div className='text-muted-foreground text-xs'>
                  Borrowed 18 times
                </div>
              </div>
            ...
            <div className='hover:bg-muted/20 flex items-center gap-3 rounded-lg p-3'>
              ...
              <div className='flex-1'>
                <div className='text-sm font-medium text-foreground'>1984</div>
                <div className='text-muted-foreground text-xs'>
                  Borrowed 15 times
                </div>
              </div>
